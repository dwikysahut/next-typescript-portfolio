...
export default function ChatItem({ index }: { index: number|0 }) {
  return (
    <>
    {
      ...
      <div className='flex flex-col justify-center bg-secondary p-1 rounded-br-none rounded-tr-xl rounded-tl-xl rounded-bl-xl px-2'>
      ...
      <div className='flex gap-2'>
        ...
        <div className='flex flex-col justify-center bg-secondary p-1 rounded-br-xl rounded-tr-xl rounded-tl-none rounded-bl-xl px-2'>
